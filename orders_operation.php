...
?>
	...
	<div class="container">
	  <div class="row">
	    <div class="col-sm-3">
	      <h3>Orders <span class="glyphicon glyphicon-bullhorn"></span></h3>
              ...
              echo "<div class='panel panel-default'>";
							echo "<div class='panel-heading'>" . "<a href='https://www.google.com'> ". $row['OrderCode'] . "</a>" . "</div>";
							echo "<div class='panel-body'>" . $row["OrderName"] . $row["OrderStatus"] . "delivery: " . $row["Order4Date"] . "</div>";
//							echo "<div class='panel-footer'>" . $row["OrderDate"] . "</div>";
			...
			<div class="col-sm-6">
				<h3>Items <span class="glyphicon glyphicon-cog"></span></h3>
				<?php
        /*
					$conn = Connect2Database();
